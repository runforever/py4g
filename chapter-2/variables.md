...
if case1:
   ...
   # do something
```
我思考了很久如何来解释分支结构，最后发现单纯的去讲有点分支有点 2，结合循环来说效果会好一些。
...
##### 死循环(endless loop)
看过《恐怖邮轮》这部电影的人都知道，主角由于欺骗死神被死神惩罚困在死循环的场景中永远无法逃脱出来，这是一件非常恐怖的事情，计算机虽然擅长做循环的事情，但是我们写的代码一定不要出现死循环，否则程序就无法结束了，除非你确定你的代码需要死循环。
...
#### 总结
目前为止我们学了基本的数据类型、变量和编程的流程控制，这些东西是编程最基础的概念，其他编程语言也类似，一开始说的编程是用代码表达自己的想法这个观点不知道你理解到了没？如果没有欢迎 email 我，c.chenchao.c@gmail.com
